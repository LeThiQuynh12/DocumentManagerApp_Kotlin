...
//@GET("documents/search/by-filetype")
//suspend fun searchDocumentsByFileType(@Query("fileType") fileTypes: List<String>): List<DocumentData>
//
...
interface DocumentApiService {
    ...
    @GET("documents/search/by-filetype")
    suspend fun searchDocumentsByFileType(@Query("fileType") fileType: String): List<DocumentData>
